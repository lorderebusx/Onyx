      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="bg-emerald-500/10 border-emerald-500/20">
          <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-emerald-600 dark:text-emerald-400">Net Savings Rate</CardTitle>
            </CardHeader>
            <CardContent>
                <div className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">71.2%</div>
                <p className="text-xs text-emerald-600/80 mt-1">Top 1% of peer group</p>
            </CardContent>
        </Card>

        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800">
            <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-zinc-500">Avg. Monthly Burn</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-zinc-900 dark:text-white">$14,850</div>
              <p className="text-xs text-zinc-500 mt-1 flex items-center">
                <ArrowDown className="h-3 w-3 mr-1 text-emerald-500" /> 
                <span className="text-emerald-500 font-medium">1.2%</span>
                <span className="ml-1">vs 3-month avg</span>
              </p>
            </CardContent>
        </Card>
        ...
        <Card className="bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800">
          <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-zinc-500">Projected Annual Savings</CardTitle>
          </CardHeader>
          <CardContent>
              <div className="text-2xl font-bold text-zinc-900 dark:text-white">$451,200</div>
              <p className="text-xs text-zinc-500 mt-1">Excludes investment returns</p>
          </CardContent>
        </Card>
      </div>
